...
module.exports = {
     ...
     ******************************************************************************/
        ...
        //     additionalExposedHeaders: ["Content-Security-Policy"],
        //     preflightContinue: false,
        //     optionsSuccessStatus: 204,
        //     setHeaders: function (req, res, next) {
        //         res.header("Content-Security-Policy",
        //             "default-src 'self'; " +
        //             "script-src 'self' 'unsafe-inline' 'unsafe-eval' data: filesystem: blob:; " +
        //             "script-src-attr 'self' 'unsafe-inline' 'unsafe-eval'; " +
        //             "style-src 'self' 'unsafe-inline'; " +
        //             "img-src 'self' data: http: https:; " +
        //             "media-src 'self'; " +
        //             "connect-src 'self' https://catalogue.nodered.org; " +
        ...
        // httpNodeMiddleware: function(req, res, next) {
        //     // Skip raw body parsing for Stripe webhook route
